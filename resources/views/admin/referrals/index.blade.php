            ...
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-lg-3 col-6 text-center">
                        <div class="border border-light border-1 border-radius-md py-3">
                            ...
                            <h4 class="font-weight-bolder mb-0"><span class="small">$ </span><span id="state1" countto="23980">23,980</span></h4>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6 text-center">
                        <div class="border border-light border-1 border-radius-md py-3">
                            <h6 class="text-primary text-gradient mb-0">Customers</h6>
                            <h4 class="font-weight-bolder mb-0"><span class="small">$ </span><span id="state2" countto="2400">2,400</span></h4>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6 text-center mt-4 mt-lg-0">
                        <div class="border border-light border-1 border-radius-md py-3">
                            <h6 class="text-primary text-gradient mb-0">Avg. Value</h6>
                            <h4 class="font-weight-bolder mb-0"><span class="small">$ </span><span id="state3" countto="48">48</span></h4>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6 text-center mt-4 mt-lg-0">
                        <div class="border border-light border-1 border-radius-md py-3">
                            <h6 class="text-primary text-gradient mb-0">Refund Rate</h6>
                            <h4 class="font-weight-bolder mb-0"><span id="state4" countto="4">4</span><span class="small"> %</span></h4>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <div class="form-group w-70">
                                    <div class="input-group bg-gray-200 border-radius-md is-filled">
                                        <input class="form-control form-control-sm border-radius-md" value="soft-ui-dashboard-vmsk392" type="text" disabled="" onfocus="focused(this)" onfocusout="defocused(this)">
                                        <span class="input-group-text bg-transparent" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Referral code expires in 24 hours"><i class="material-icons text-sm me-2">timer</i></span>
                                    </div>
                                </div>
                                <a href="javascript:;" class="btn btn-sm btn-outline-secondary ms-2 px-3 mb-0">Copy</a>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="card card-plain text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="text-sm font-weight-normal mb-2">1. Create &amp; validate your referral link and get </p>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="card card-plain text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="text-sm font-weight-normal mb-2">2. For every order you make you get </p>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="card card-plain text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="text-sm font-weight-normal mb-2">3. Get other friends to generate link and get </p>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 mt-lg-0">
                        <div class="card text-center">
                            <div class="overflow-hidden position-relative border-radius-lg bg-cover p-3" style="background-image: url('../../assets/img/home-decor-1.jpg')">
                                <span class="mask bg-gradient-dark opacity-6"></span>
                                <div class="card-body position-relative z-index-1 d-flex flex-column mt-5">
                                    <p class="text-white font-weight-bolder">Refer one friend and you will get $100 on each product he purchases.</p>
                                    <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-4" href="javascript:;">
                                        Read More
                                        <i class="material-icons text-sm ms-1 position-relative" aria-hidden="true">arrow_forward</i>
                                    </a>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex px-3 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span class="text-success font-weight-bold">8.232</span> orders</p>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="align-middle text-end">
                                <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                    ...
                                    <i class="material-icons ms-1 mt-1 text-success opacity-10" aria-hidden="true" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Refund rate is lower with 97% than other users">expand_less</i>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="d-flex px-3 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span class="text-success font-weight-bold">12.821</span> orders</p>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex px-3 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span class="text-success font-weight-bold">2.421</span> orders</p>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex px-3 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span class="text-success font-weight-bold">5.921</span> orders</p>
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex px-3 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span class="text-success font-weight-bold">921</span> orders</p>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="align-middle text-end">
                                <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                    ...
                                    <i class="material-icons ms-1 mt-1 text-danger opacity-10" aria-hidden="true" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Refund rate is higher with 70% than other users">expand_more</i>
                                </div>
                            </td>
                        </tr>
                        </tbody>
